...
public class SpeechRecognition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint("MissingInflatedId") final EditText editText = findViewById(R.id.editText);
        ...
        Button buttonspeech = findViewById(R.id.btn);
        buttonspeech.setOnTouchListener(new View.OnTouchListener() {
